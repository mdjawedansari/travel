    ...
    <div className='trip'>
      ...
      <div className='tripcard'>
        ...
        <TripData 
          ...
          text="France, in Western Europe, encompasses medival cities, alpine villages and Mediterranean beaches. Paris, its capital, is famed for its fashion houses, classical art museums including the Louvre and monuments like the Eiffel Tower."
        />
      </div>
    </div>
  )
